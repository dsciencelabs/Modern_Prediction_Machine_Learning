...
```{r, results='asis', fungsi,echo=FALSE, fig.cap='Ilustrasi Manipulasi Data dalam R', tidy=FALSE, out.width='100%', fig.align='center'}
...
<!--chapter:end:04_Database_Normalization_in_SQL.Rmd-->
