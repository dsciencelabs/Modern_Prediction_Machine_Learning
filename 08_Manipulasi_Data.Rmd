...
```{r interface,echo=FALSE, fig.cap='Interface Data', tidy=FALSE, out.width='100%', fig.align='center'}
library(knitr)
img1_path <- "./images/Bab7/Interface_Data.png"
...
```{r echo=FALSE, results='asis'}
cat('<iframe width="800" height="430" src="https://www.youtube.com/embed/rs5hz_oZywI" frameborder="0" allowfullscreen></iframe>')
```
...
```{r echo=FALSE, results='asis'}
cat('<iframe width="800" height="430" src="https://www.youtube.com/embed/2q5bAvNlBsc" frameborder="0" allowfullscreen></iframe>')
```
