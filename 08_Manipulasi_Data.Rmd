...
```{r, results='asis', manipulasi,echo=FALSE, fig.cap='Ilustrasi Manipulasi Data dalam R', tidy=FALSE, out.width='100%', fig.align='center'}
cat('<img src="./images/Bab8/dataillustration.gif">')
```
...
```{r, eval=FALSE}
PATH <- "https://raw.githubusercontent.com/dsciencelabs/Algoritma_Pemrograman_R/main/Data/Missing_Values.csv"
